    ...
    <div class="col-sm-9">
      ...
      <h1>Sửa danh mục</h1>	
		...
		<s:form action="updateDanhMucAction" method="POST" enctype="multipart/form-data" validate="true">
			<input type="hidden" name="iddanhmuc" value='<s:property value="danhmuc.iddanhmuc"/>'/>
		
			
			<div class="form-group">
				<label>Tên danh mục</label>
				<input class="form-control" type="text" id="tendanhmuc" name="tendanhmuc" value="<s:property value="danhmuc.tendanhmuc"/>">
			</div>
