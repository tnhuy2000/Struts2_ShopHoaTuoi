  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Danh sách danh mục</h1>	
		...
		<p><a class="btn btn-primary" href="createDanhMucAction">Thêm mới</a>
		...
		<tr>
			...
			<td><a href='editDanhMucAction?iddanhmuc=<s:property value="iddanhmuc"/>'>Chỉnh sửa</a></td>
			<td><a href='deleteDanhMucAction?iddanhmuc=<s:property value="iddanhmuc"/>' onclick="return confirm('Bạn chắc chắn xóa?')">Xóa</a></td>
		</tr>
		</s:iterator>
		<tbody>
		</table>
