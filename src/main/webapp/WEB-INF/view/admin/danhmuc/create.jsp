...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Thêm danh mục</h1>	
		<br>
		<s:form action="storeDanhMucAction" method="POST" enctype="multipart/form-data" validate="true">
		
		
		<div class="form-group">
			<label class="control-label">Tên danh mục</label>
			<input class="form-control" type="text" id="tendanhmuc" name="tendanhmuc" required>
		</div>
