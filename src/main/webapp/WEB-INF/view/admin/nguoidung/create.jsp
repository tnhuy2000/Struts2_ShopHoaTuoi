  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Thêm người dùng</h1>	
		<br>
		<s:form action="storeUserAction" method="POST" enctype="multipart/form-data" validate="true">
		...
		<div class="form-group">
			...
			<input class="form-control" type="number" id="sodienthoai" name="sodienthoai" required>
