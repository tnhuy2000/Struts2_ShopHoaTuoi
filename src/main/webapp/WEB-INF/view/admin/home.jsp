      ...
      <br><br>
	      ...
	      <div class="panel panel-primary">
	        ...
	        <div class="panel-body bg-primary">
				<a href="listHoaAction"	>
				<img src="./img/icon5.png" height="120px"  alt="">
				</a>
	        </div>
	        <div class="panel-footer"><a href="listHoaAction">Quản lý hoa tươi</a></div>
	      </div>
	    </div>
	     <div class="col-sm-3">
	      <div class="panel panel-primary">
	        <div class="panel-body bg-primary">
				<a href="listDanhMucAction"	>
				<img src="./img/icon4.png" height="120px"  alt="">
				</a>
	        </div>
	        <div class="panel-footer"><a href="listDanhMucAction">Quản lý danh mục</a></div>
	      </div>
	    </div>
	    ...
	    <div class="col-sm-3">
	      <div class="panel panel-primary">
	        ...
	        <div class="panel-body bg-primary">
				<a href="listDonHangAction"	>
				<img src="./img/icon0.png" height="120px"  alt="">
				</a>
	        </div>
	        <div class="panel-footer"><a href="listDonHangAction">Quản lý đơn hàng</a></div>
	      </div>
	    </div>
	    <div class="col-sm-3">
	      <div class="panel panel-primary">
	        ...
	        <div class="panel-body bg-primary">
				<a href="listUserAction"	>
				<img src="./img/icon2.png" height="120px"  alt="">
				</a>
	        </div>
	        <div class="panel-footer"><a href="listUserAction">Quản lý người dùng</a></div>
	      </div>
	    </div>
   </div>
  </div>
