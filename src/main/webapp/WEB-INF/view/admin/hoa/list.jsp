...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Danh sách hoa tươi</h1>	
		 <s:if test="hasActionMessages()">
	        <div class="text-danger">
	           <b><s:actionmessage /></b>  
	        </div>
    	</s:if>
		<p><a class="btn btn-primary" href="createHoaAction">Thêm mới</a>
		...
		<tr>
			<s:iterator var="danhmuc" value="danhmuclist" >
				<s:if test="iddanhmuc==fk_iddanhmuc">
				<td><s:property value="tendanhmuc"/></td>
				</s:if>
			</s:iterator>
			<td><s:property value="tenhoa"/></td>
			...
			<td><a href='editHoaAction?id=<s:property value="idhoatuoi"/>'>Chỉnh sửa</a></td>
			<td><a href='deleteHoaAction?id=<s:property value="idhoatuoi"/>' onclick="return confirm('Bạn chắc chắn xóa?')">Xóa</a></td>
		</tr>
		</s:iterator>
		<tbody>
		</table>
