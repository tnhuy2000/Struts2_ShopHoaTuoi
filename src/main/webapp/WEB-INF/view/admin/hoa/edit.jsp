...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Sửa hoa</h1>	
		<br>
		<s:form action="updateHoaAction" method="POST" enctype="multipart/form-data" validate="true">
			<input type="hidden" name="id" value='<s:property value="hoa.idhoatuoi"/>'/>
			<div class="form-group">
				<label>Danh mục</label>
				<select class="form-control" name="iddanhmuc">
				<s:iterator var="danhmuc" value="danhmuclist" >
					<s:if test="hoa.fk_iddanhmuc==iddanhmuc">
						<option value="<s:property value="iddanhmuc"/>" selected><s:property value="tendanhmuc"/></option>
					</s:if>
					<s:else>
					   <option value="<s:property value="iddanhmuc"/>"><s:property value="tendanhmuc"/></option>
					</s:else>
				</s:iterator>
				</select>
			</div>
			...
			<div class="form-group">
				<label>Tên hoa</label>
				<input class="form-control" type="text" id="tenhoa" name="tenhoa" value="<s:property value="hoa.tenhoa"/>">
			</div>
			<div class="form-group">
				<label>Giá</label>
				<input class="form-control" type="number" id="gia" name="gia"  value="<s:property value="hoa.gia"/>">
			</div>
			<div class="form-group">
				<label>Mô tả</label>
				<textarea class="form-control" name="mota" id="mota"><s:property value="hoa.mota"/></textarea>
			</div>
			<div class="form-row">
				<div class="form-group col-sm-6">
					<label>Lượt xem</label>
					<input class="form-control" type="number" id="luotxem" name="luotxem" value="<s:property value="hoa.luotxem"/>">
				</div>
				<div class="form-group col-sm-6">
					<label>Lượt mua</label>
					<input class="form-control" type="number" id="luotmua"name="luotmua" value="<s:property value="hoa.luotmua"/>">
				</div>
			</div>
			<div class="form-group">
				<label>Hình ảnh</label>
				<img class="img-thumnail" width='80' src='./img/<s:property value="hoa.hinh"/>'/>
				<input class="form-control" type="file" name="hinh" accept="image/png, image/jpg, image/jpeg, image/gif">
