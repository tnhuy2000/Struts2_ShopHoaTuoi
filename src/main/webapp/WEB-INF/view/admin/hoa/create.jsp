...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h1>Thêm hoa</h1>	
		<br>
		<s:form action="storeHoaAction" method="POST" enctype="multipart/form-data" validate="true">
		...
		<div class="form-group">
			<label class="control-label">Tên hoa</label>
			<input class="form-control" type="text" id="tenhoa" name="tenhoa" required>
		</div>
		<div class="form-group">
			<label class="control-label">Giá</label>
			<input class="form-control" type="number" id="gia" name="gia" value="0" min=0 required>
		</div>
		<div class="form-group">
			<label>Mô tả</label>
